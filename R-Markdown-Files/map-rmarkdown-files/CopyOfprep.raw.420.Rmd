...
prep <- read_csv("~/Desktop/data/Team_AMIE_670_Project/Active-data-sets/prep.csv")%>%
dplyr::select(Year, State, `State PrEP Users`)

incidenceData <- read.csv("~/Desktop/data/Team_AMIE_670_Project/Active-data-sets/incidenceDat.csv") %>%
