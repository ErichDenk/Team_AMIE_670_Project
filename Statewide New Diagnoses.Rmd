...
state_diag_2008 <- read_excel("Source-Data/state-newdx/AIDSVu_State_New-DX-Data-Sets_2008.xlsx")
state_diag_2009 <- read_excel("Source-Data/state-newdx/AIDSVu_State_New-DX-Data-Sets_2009.xlsx")
state_diag_2010 <- read_excel("Source-Data/state-newdx/AIDSVu_State_New-DX-Data-Sets_2010.xlsx")
state_diag_2011 <- read_excel("Source-Data/state-newdx/AIDSVu_State_New-DX-Data-Sets_2011.xlsx")
state_diag_2012 <- read_excel("Source-Data/state-newdx/AIDSVu_State_New-DX-Data-Sets_2012.xlsx")
state_diag_2013 <- read_excel("Source-Data/state-newdx/AIDSVu_State_New-DX-Data-Sets_2013.xlsx")
state_diag_2014 <- read_excel("Source-Data/state-newdx/AIDSVu_State_New-DX-Data-Sets_2014.xlsx")
state_diag_2015 <- read_excel("Source-Data/state-newdx/AIDSVu_State_New-DX-Data-Sets_2015.xlsx")
state_diag_2016 <- read_excel("Source-Data/state-newdx/AIDSVu_State_New-DX-Data-Sets_2016.xlsx")
```
...
write_csv(diag_08_16, 
          file.path("Active-data-sets/statewide-new-diagnoses-clean.csv"))
```
